...
{% include figure.html file="/assets/20190521/01.png" alt="01" caption="Navigation Cotroller (출처: apple developer)" width="fitcontent" border="true" %} <br><br>
...
<br><br>
{% include figure.html file="/assets/20190521/02.jpeg" alt="02" caption="Back Button이 없다면 어떻게 뒤로 돌아갈 수 있을까요." width="fitcontent" border="true" %} <br><br>
...
```
<br><br>
{% include figure.html file="/assets/20190521/03.jpeg" alt="03" caption="Back Button에 '상품정보' 타이틀이 보입니다." width="fitcontent" border="true" %} 
<br>
...
```
<br><br>
{% include figure.html file="/assets/20190521/04.jpeg" alt="04" caption="짜잔- Back Button의 타이틀이 사라졌습니다!" width="fitcontent" border="true" %}<br><br>
...
```
<br><br>
{% include figure.html file="/assets/20190521/05.jpeg" alt="05" caption="타이틀뷰, LeftBarButton, RightBarButton이 모두 커스텀된 브랜디의 홈" width="fitcontent" border="true" %} <br><br>
