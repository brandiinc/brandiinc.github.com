...
{% include figure.html file="/assets/20180807/01.png" alt="01" caption="" border="true" %}
...
{% include figure.html file="/assets/20180807/02.PNG" alt="02" caption="8.11.3 LTS버전으로 진행했습니다." border="true" %} <br>
...
```
<br><br>
{% include figure.html file="/assets/20180807/03.PNG" alt="03" caption="잘 설치되었네요." width="fitcontent" border="true" %} 
...
```
<br><br>
{% include figure.html file="/assets/20180807/04.PNG" alt="04" caption="" width="fitcontent" border="true" %}<br><br>
...
```
<br><br>
{% include figure.html file="/assets/20180807/06.PNG" alt="06" caption="" border="true" %}<br><br>
...
{% include figure.html file="/assets/20180807/05.PNG" alt="05" caption="지금까지 진행한 파일 모습입니다." width="fitcontent" border="true" %} 
...
```
<br>
{% include figure.html file="/assets/20180807/07.PNG" alt="07" caption="잘 나옵니다." width="fitcontent" border="true" %} <br>

{% include figure.html file="/assets/20180807/08.PNG" alt="08" caption="" width="fitcontent" border="true" %}<br>

{% include figure.html file="/assets/20180807/09.PNG" alt="09" caption="정상적으로 VUE가 적용된 것을 확인합니다." width="fitcontent" border="true" %} <br><br>
...
```
<br>
{% include figure.html file="/assets/20180807/10.PNG" alt="10" caption="" width="fitcontent" border="true" %}
...
{% include figure.html file="/assets/20180807/11.png" alt="11" caption="" width="fitcontent" border="true" %}<br>

{% include figure.html file="/assets/20180807/12.png" alt="12" caption="" width="fitcontent" border="true" %}<br>

{% include figure.html file="/assets/20180807/13.png" alt="13" caption="" width="fitcontent" border="true" %}
...
{% include figure.html file="/assets/20180807/14.png" alt="14" caption="" width="fitcontent" border="true" %}
...
{% include figure.html file="/assets/20180807/15.png" alt="15" caption="짜잔" width="fitcontent" border="true" %} 
...
{% include figure.html file="/assets/20180807/16.png" alt="16" caption="" border="true" %}
...
{% include figure.html file="/assets/20180807/17.png" alt="17" caption="붉은 네모 부분이 실제로 제작하거나 수정한 파일들입니다." width="fitcontent" border="true" %} <br><br>
