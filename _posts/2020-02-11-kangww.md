...
{% include figure.html file="/assets/20200211/01.png" alt="sam" width="fitcontent" caption="CodeStar Project 생성 시 기본 세팅 모습. 언제든 요소를 추가하거나 뺄 수 있다." %}<br />
...
{% include figure.html file="/assets/20200211/02.png" alt="sam" width="fitcontent" caption="람다 문양 모자를 쓴 샘람쥐" %}<br />
...
{% include figure.html file="/assets/20200211/03.png" alt="sam" width="fitcontent" caption="도커 컨테이너를 따듯하게 유지할 수 없나요!?" %}<br />
...
{% include figure.html file="/assets/20200211/04.png" alt="sam" width="fitcontent" %}<br />
...
{% include figure.html file="/assets/20200211/05.png" alt="sam" width="fitcontent" %}
...
{% include figure.html file="/assets/20200211/06.png" alt="sam" width="fitcontent" %}
...
{% include figure.html file="/assets/20200211/07.png" alt="sam" width="fitcontent" %}

2\. 한번 실행하면 우측 상단에 등록되는데 여기서 Edit Configurations를 눌러 줍니다.

{% include figure.html file="/assets/20200211/08.png" alt="sam" width="fitcontent" %}

3\. Configuration 탭의 Parameters에 원하는 호스트와 포트를 작성해 줍니다. (이것 때문에 Flask에 옵션을 받는 로직이 꼭 필요합니다.)

{% include figure.html file="/assets/20200211/09.png" alt="sam" width="fitcontent" %}
