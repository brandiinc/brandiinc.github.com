...
{% include figure.html file="/assets/20181213/01.png" alt="01" caption="Vuex다이어그램, 출처: Vuex 공식 사이트" border="true" %} <br>
...
{% include figure.html file="/assets/20181213/02.png" alt="02" caption="최근에 새로 출시되었군요." border="true" %} 
<br>
...
{% include figure.html file="/assets/20181213/03.png" alt="03" caption="babel core" border="true" %} <br>
{% include figure.html file="/assets/20181213/04.png" alt="04" caption="babel preset" border="true" %} <br>
...
{% include figure.html file="/assets/20181213/05.png" alt="05" caption="" width="fitcontent" border="true" %}
...
{% include figure.html file="/assets/20181213/06.png" alt="06" caption="로딩 직후" width="fitcontent" border="true" %}
<br>
{% include figure.html file="/assets/20181213/07.png" alt="07" caption="로딩 1초 후" width="fitcontent" border="true" %} 
<br>
호출과 핸들링 모두 잘 됩니다.
...
{% include figure.html file="/assets/20181213/08.png" alt="08" caption="로딩 직후" width="fitcontent" border="true" %} <br>
{% include figure.html file="/assets/20181213/09.png" alt="09" caption="로딩 1초 후" width="fitcontent" border="true" %} 
<br>
...
{% include figure.html file="/assets/20181213/10.png" alt="10" caption="" width="fitcontent" border="true" %}<br>
...
{% include figure.html file="/assets/20181213/11.png" alt="11" caption="상품 관리 화면" border="true" %} <br>
...
{% include figure.html file="/assets/20181213/12.png" alt="12" caption="스토어의 선택된 상품번호 목록 보여주기" border="true" %} <br>
