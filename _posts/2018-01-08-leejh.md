...
"개발자 프로그램이 뭐 이렇게 비싸?"
 <br><br>
  {% include figure.html file="/assets/20180108/01.png" alt="XCode" caption="XCode" border="true" %}
...
<br><br>
  ...
  {% include figure.html file="/assets/20180108/02.png" alt="답변" caption="그들의 답변..." border="true" %} <br>
...
<br><br>
 ...
 {% include figure.html file="/assets/20180108/03.png" alt="iTunes" caption="iTunesConnect" %} <br>
...
앱을 개발했다면, 테스트플라이트(TestFlight)를 통해 실제로 앱을 배포하기 전 '시험비행'을 할 수 있습니다. iTunesConnect에 관련 테스터들을 등록하고, 등록된 사용자들을 대상으로 미리 앱을 테스트할 수 있도록 요청하는 것이죠. 이 테스트플라이트에 배포된 바이너리를 그대로 AppStore에 배포하게 되므로, 테스트용으로 유용합니다.<br><br>
 ...
 {% include figure.html file="/assets/20180108/04.jpeg" alt="TestFlight" caption="TestFlight" width="70" border="true" %} <br>
...
{% include figure.html file="/assets/20180108/05.png" alt="Organizer" caption="Organizer와 Crash Report" %} <br>
...
{% include figure.html file="/assets/20180108/06.jpg" alt="짜란" caption="짜잔! 공개합니다!" width="50" %} <br><br>
...
Optimization Setting을 변경할 때는 꼭 Debug 항목만 변경하고, Release 버전은 기존 설정을 유지하는 것이 좋습니다. 그래야 빌드 과정에서의 버그를 막을 수 있기 때문이죠. 만약 이 설정으로 개발하던 도중 소스가 충돌되면 Command+K 단축키를 눌러 소스를 한 번 클린하고, 재빌드하세요. 충돌이 사라지는 경우가 많습니다. 빠른 빌드를 위해 종종 감수해야 하는 부분이기도 합니다.
<br>
...
{% include figure.html file="/assets/20180108/07.png" alt="Derived Data" caption="Derived Data 접근 경로" %} <br>
...
{% include figure.html file="/assets/20180108/08.png" alt="CocoaPods" caption="CocoaPods" %} <br>

오픈소스 라이브러리가 설치되었습니다. 귀찮은 소스 다운로드와 임포트 과정을 거치지 않아도 됩니다. CocoaPods 설치와 사용에 관한 글은 구글링으로 쉽게 찾을 수 있습니다. 꼭 사용하길 권합니다.<br><br>

{% include figure.html file="/assets/20180108/09.png" alt="XCode평점" caption="Mac App Store에서의 XCode 평점" %} <br>
...
{% include figure.html file="/assets/20180108/10.jpeg" alt="situation" caption="금융권 앱. 화면에 꽉 차지 않는 레이아웃 혹은 비정상적으로 커진 글씨" width="70" %} <br>
...
{% include figure.html file="/assets/20180108/11.png" alt="Autolayout" caption="AutoLayout, Layout Constraint" %} <br>
