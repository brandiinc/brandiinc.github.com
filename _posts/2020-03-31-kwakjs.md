...
{% include figure.html file="/assets/20200331/01.png" alt="chatbot" width="fitcontent" %}
<br />

<span class="indent">2. SNS topic을 생성</span>

{% include figure.html file="/assets/20200331/02.png" alt="chatbot" width="fitcontent" %}

{% include figure.html file="/assets/20200331/03.png" alt="chatbot" width="fitcontent" %}
<br />
...
{% include figure.html file="/assets/20200331/04.png" alt="chatbot" width="fitcontent" %}

{% include figure.html file="/assets/20200331/05.png" alt="chatbot" width="fitcontent" %}

{% include figure.html file="/assets/20200331/06.png" alt="chatbot" width="fitcontent" %}
...
{% include figure.html file="/assets/20200331/07.png" alt="chatbot" width="fitcontent" %}
<br />

<span class="indent">5. SNS Topic (slack-notice)에 Subscriptions 추가</span>

{% include figure.html file="/assets/20200331/08.png" alt="chatbot" width="fitcontent" %}

{% include figure.html file="/assets/20200331/09.png" alt="chatbot" width="fitcontent" %}

{% include figure.html file="/assets/20200331/10.png" alt="chatbot" width="fitcontent" %}
...
{% include figure.html file="/assets/20200331/11.png" alt="chatbot" width="fitcontent" %}
...
{% include figure.html file="/assets/20200331/12.png" alt="chatbot" width="fitcontent" %}
<br />

<span class="indent">2. AWS Chatbot 생성</span>
<span class="indent2">1. Slack 선택</span>

{% include figure.html file="/assets/20200331/13.png" alt="chatbot" width="90" %}
<br />

<span class="indent2">2. Slack 계정 인증 후 엑세스 권한 요청 승인</span>

{% include figure.html file="/assets/20200331/14.png" alt="chatbot" width="90" %}
<br />

<span class="indent2">3. Slack 계정 작업 공간에 채널을 추가</span>

{% include figure.html file="/assets/20200331/15.png" alt="chatbot" width="90" %}
<br />

<span class="indent2">4. Slack Channel 생성</span>
<span class="indent3">1. Step-1</span>

{% include figure.html file="/assets/20200331/16.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/17.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/18.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/19.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/20.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/21.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/24.png" alt="chatbot" width="90" %}

{% include figure.html file="/assets/20200331/22.png" alt="chatbot" width="90" %}
...
{% include figure.html file="/assets/20200331/25.png" alt="chatbot" width="90" %}

{% include figure.html file="/assets/20200331/23.png" alt="chatbot" width="90" %}
