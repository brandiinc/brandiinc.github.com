---
title: Shallow dive into the iOS (1/2)
layout: post
cover: "/assets/default.jpg"
facebookImg: "/assets/20180716/01.jpg"
author: leejh
subtitle: Layout does matter! iOS Graphic Interface 살펴보기
...
{% include figure.html file="/assets/20180716/01.jpg" alt="01" caption="1X, 2X, 3X" width="fitcontent" border="true" %}<br>
...
{% include figure.html file="/assets/20180716/02.jpg" alt="02" caption="애플의 해상도 춘추전국시대 / 출처: paintcodeapp" border="true" %}
<br><br><br>
...
{% include figure.html file="/assets/20180716/03.jpg" alt="03" caption="UIStoryboard 예시 - 브랜디 iOS의 Main Storyboard" border="true" %} <br>
...
{% include figure.html file="/assets/20180716/04.jpg" alt="04" caption="UICollectionViewCell.xib" border="true" %} <br>
...
{% include figure.html file="/assets/20180716/05.jpg" alt="05" caption="소스코드로 스토리보드 보기" width="fitcontent" border="true" %}<br><br><br>
...
{% include figure.html file="/assets/20180716/06.jpg" alt="06" caption="Less than or equal" width="fitcontent" border="true" %}<br>
...
{% include figure.html file="/assets/20180716/07.jpg" alt="07" caption="무조건입니다." width="fitcontent" border="true" %}<br>
...
{% include figure.html file="/assets/20180716/08.jpg" alt="08" caption="Storyboard에서 클리핑" width="fitcontent" border="true" %}<br>
...
{% include figure.html file="/assets/20180716/09.png" alt="09" caption="" border="true" %}<br>
...
{% include figure.html file="/assets/20180716/10.png" alt="10" caption="볼드체, 보통체가 혼합된 텍스트에 색상이 다른 텍스트가 혼재되어 있는 Attributed String " border="true" %}<br>
...
{% include figure.html file="/assets/20180716/11.jpg" alt="11" caption="Devices and Simulators" width="fitcontent" border="true" %}  <br>
...
{% include figure.html file="/assets/20180716/12.jpg" alt="12" caption="무선디버깅체크" width="fitcontent" border="true" %}<br><br><br>
