...
{% include figure.html file="/assets/20180703/01.PNG" alt="01" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/02.PNG" alt="02" caption="" border="true" %}
GithubPage로 만들자는 의견과 jekyll을 이용하면 빠르고 쉽게 만들 수 있을 거란 의견이 있었습니다. 그리고 곧바로 제작에 참여했죠.<br><br><br><br>

{% include figure.html file="/assets/20180703/03.PNG" alt="03" caption="" border="true" %}
참 쉽다는데.. 별로 공감하시는 분은 없을 겁니다. 지금까지 겪었던 개발 과정을 이번 발표에서 소개하겠습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/04.PNG" alt="04" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/05.PNG" alt="05" caption="" border="true" %}
GithubPage를 구축하는 데에는 HEXO와 jekyll을 많이 사용합니다. 근우님은 jekyll 템플릿을 선호해서 그것을 선택했습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/06.PNG" alt="06" caption="" border="true" %}
이것은 jekyll 공식 홈페이지입니다. 단 몇 초면 가능하다고 하지만 실제로는 좀 더 걸립니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/07.PNG" alt="07" caption="" border="true" %}
bundler와 jekyll을 설치하면 됩니다. 설치가 완료되면 jekyll serve를 실행해 jekyll을 구동합니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/08.PNG" alt="08" caption="" border="true" %}
구동하면 localhost로 들어가서 확인할 수 있습니다. 위의 화면은 아무 작업도 하지 않은 jekyll의 모습입니다. <br><br><br><br>

{% include figure.html file="/assets/20180703/09.PNG" alt="09" caption="" border="true" %}
설치까진 쉽게 되었지만 이제부터 무엇을 어떻게 해야 할까요? 블로그 작성에 대한 가이드도 없고 페이지나 이미지 추가 작업을 커맨드로만 해야 한다니 선뜻 시작하기가 어렵습니다. <br><br><br><br>

{% include figure.html file="/assets/20180703/10.PNG" alt="10" caption="jekyll admin plugin" border="true" %}
그래서 검색을 해봤습니다. 관리자 기능이 어딘가 숨어있을 것 같았습니다. 다행히 공식사이트에 jekyll admin plugin이 있었습니다. plugin은 어떻게 건드려야 할까요?<br><br><br><br>

{% include figure.html file="/assets/20180703/11.PNG" alt="11" caption="" border="true" %}
우연히 gemfile을 수정하라는 영문 설명을 찾았습니다. gemfile을 열어서 수정하고, bundler install을 하니 설치되었습니다. <br><br><br><br>

{% include figure.html file="/assets/20180703/12.PNG" alt="12" caption="" border="true" %}
jekyll을 다시 구동하니 드디어 관리자 페이지가 제 local에서 모습을 드러냈습니다. <br><br><br><br>

{% include figure.html file="/assets/20180703/13.PNG" alt="13" caption="" border="true" %}
작성을 해보려고 했는데 뭔가 이상했습니다. 위지웍에디터도 아닌 textarea만 덩그러니 있었기 때문입니다. 다시 구글링을 해야 했습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/14.PNG" alt="14" caption="markdown 넌 누구?" border="true" %}
이번엔 markdown이군요. markdown은 wiki나 github에서 가이드 문서를 쓸 때 많이 사용합니다. <br><br><br><br>

{% include figure.html file="/assets/20180703/15.PNG" alt="15" caption="" border="true" %}
markdown으로 프로그램 코드를 작성하면 코드 블럭처리가 되는데, jekyll에서 신텍스하이라이트가 기능을 지원해줍니다. jekyll을 선택하고 처음으로 따봉을 날린 순간이였습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/16.PNG" alt="16" caption="" border="true" %}
커스터마이징 과정을 설명하기 전, jekyll의 구성부터 소개하겠습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/17.PNG" alt="17" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/18.PNG" alt="18" caption="" border="true" %}
이제 본격적으로 브랜디 기술블로그를 커스터마이징한 과정을 소개하겠습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/19.PNG" alt="19" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/20.PNG" alt="20" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/21.PNG" alt="21" caption="" border="true" %}
이미지도 markdown 문법으로 넣습니다. 원하는 위치에 markdown 이미지 코드를 적으면 되는데요. 이때 이미지 파일은 *assets* 폴더 하위로 넣으면 됩니다. <br><br><br><br>

{% include figure.html file="/assets/20180703/22.PNG" alt="22" caption="야인슈타인 메롱!" border="true" %}
제대로 했다면 이미지가 나올 겁니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/23.PNG" alt="23" caption="" border="true" %}
Gnav 변경부터는 진짜 커스터마이징입니다. jekyll 프로젝트 구조를 뜯어고쳐야 하기 때문입니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/24.PNG" alt="24" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/25.PNG" alt="25" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/26.PNG" alt="26" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/27.PNG" alt="27" caption="" border="true" %}
다른 것도 많이 고쳤지만, 끝판왕을 소개하겠습니다. 저자 기능은 완전 새로운 기능이라 꽤 오랜 시간을 들여서 작업했습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/28.PNG" alt="28" caption="" border="true" %}
이것은 완성된 저자 메인 페이지입니다. 저자에 대한 소개와 저자가 작성한 글 목록이 보입니다. 각 게시글의 글쓴이 이름을 클릭하면 볼 수 있습니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/29.PNG" alt="29" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/30.PNG" alt="30" caption="" border="true" %}
저자마다 페이지를 만듭니다. 저자 페이지 내용을 직접 사용하지 않기 때문에 내용에는 간략한 저자 소개를 적어두면 됩니다. 저자 페이지를 추가하면 저자 메인 페이지가 generate됩니다.<br><br><br><br>

{% include figure.html file="/assets/20180703/31.PNG" alt="31" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/32.PNG" alt="32" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/33.PNG" alt="33" caption="" border="true" %}
...
{% include figure.html file="/assets/20180703/34.PNG" alt="34" caption="" border="true" %}
