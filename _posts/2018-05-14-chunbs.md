...
{% include figure.html file="/assets/20180514/00.png" alt="00" caption="설치가 성공했다!" border="true" %}
...
{% include figure.html file="/assets/20180514/01.png" alt="01" caption="커멘드 지옥.." border="true" %} 
<br>
...
{% include figure.html file="/assets/20180514/02.png" alt="02" caption="jekyll-admin 공식 사이트 이미지" border="true" %}
<br>
...
{% include figure.html file="/assets/20180514/03.png" alt="03" caption="" border="true" %}
<br>
...
{% include figure.html file="/assets/20180514/04.jpeg" alt="04" caption="" border="true" %}
<br>
<br><br>
## 3. 마크다운, 넌 누구?
...
{% include figure.html file="/assets/20180514/05.jpeg" alt="05" caption="..." border="true" %}
<br>
...
<br>
{% include figure.html file="/assets/20180514/06.png" alt="06" caption="" border="true" %}
<br>
...
관리자의 configuration 메뉴를 이용하거나, 프로젝트 루트에서 _config.xml 을 열고 수정해도 됩니다. 사이트에서 사용할 전역 변수나, 플로그인, 기본값 등을 관리해주기 때문에 자주 수정하는 파일입니다. <br><br>

제목을 변경하려면 title을 찾아서 변경하면 됩니다. 그외의 하단 문구는 buttomtitle을 변경하면 됩니다. 아래 보이는 각종 정보들은 맞게 수정하면 되고,  social: 밑에 있는 정보들은 나중에 페이스북 공유나, 트위터 공유 등으로 사용할 수 있습니다. 해당 정보가 없거나 공유를 원치 않는다면 share를 false로 변경합니다. _config.xml은 수정 후 재시작을 해야만 반영되므로 jekyll를 다시 실행하면 됩니다.<br><br><br>
...
{% include figure.html file="/assets/20180514/06_2.jpeg" alt="06_2" caption="테마가 적용된 화면" border="true" %}
<br><br>
...
```
<br>
{% include figure.html file="/assets/20180514/06_3.png" alt="06_3" caption="assets/test.jpg" border="true" %}
{% include figure.html file="/assets/20180514/06_4.png" alt="06_4" caption="적용된 이미지" border="true" %}
<br>
...
{% include figure.html file="/assets/20180514/top.png" alt="07" caption="커스터마이징한 Gnav영역" border="true" %}
...
{% include figure.html file="/assets/20180514/07.png" alt="07" caption="" border="true" %}
<br>
...
{% endraw %}```
<br>
{% include figure.html file="/assets/20180514/06_5.png" alt="06_5" caption="글에 옵션을 지정한 화면" border="true" %}
<br>
...
{% include figure.html file="/assets/20180514/08.png" alt="08" caption="완성된 작성자 기능" border="true" %}
<br>
...
{% include figure.html file="/assets/20180514/09.png" alt="09" caption="" border="true" width="fitcontent" %}
<br>
...
{% include figure.html file="/assets/20180514/10.png" alt="10" caption="" border="true" %}
<br>
포스팅마다 저자의 정보가 공통적으로 나와야 하기 때문애 위의 전역변수에 authors를 추가해 따로 관리하게 했습니다.<br><br>

{% include figure.html file="/assets/20180514/11.png" alt="11" caption="" width="fitcontent" border="true" %}
<br>
```
# data/authors.yml
# authors 공용 변수
