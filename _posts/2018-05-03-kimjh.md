...
{% include figure.html file="/assets/20180513/01.png" alt="01" caption="List style Settings App and Grid style Photos App Screenshot" border="true" %}<br><br>
...
{% include figure.html file="/assets/20180513/02.png" alt="02" caption="plain style Contacts app and grouped style Settings app." border="true" %}
...
{% include figure.html file="/assets/20180513/03.png" alt="03" caption="" border="true" %}<br>
...
{% include figure.html file="/assets/20180513/04.png" alt="04" caption="" border="true" %}<br>
...
{% include figure.html file="/assets/20180513/05.png" alt="05" caption="" border="true" %}<br>
