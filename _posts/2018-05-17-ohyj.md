...
{% include figure.html file="/assets/20180517/01.png" alt="01" caption="sage는 마법사, 현자라는 의미입니다." border="true" %}
<br><br><br><br>

# sageMaker를 create하자! 
“자, 퐈이팅 넘치게 신나게 sagemaker를 create해볼까요!” 했는데...<br><br>

{% include figure.html file="/assets/20180517/02.png" alt="02" caption="Seoul Region이 없다!" border="true" %}
<br>
...
{% include figure.html file="/assets/20180517/03.png" alt="03" caption="" border="true" %}
<br>
중요한 점은, bucket 이름이 “sagemaker-” 로 시작되어야 한다는 것입니다. 그래야 나중에 notebook instance가 어느 곳에 데이터를 저장할지 알 수 있습니다. <br><br>

{% include figure.html file="/assets/20180517/04.png" alt="04" caption="" border="true" %}

{% include figure.html file="/assets/20180517/05.png" alt="05" caption="Next, Create bucket 버튼을 누르다 보니, S3 Bucket이 생성되었습니다." border="true" %}<br><br><br>


## 2. Create notebook instance 버튼을 눌러 SageMaker를 만들어 봅시다!
{% include figure.html file="/assets/20180517/06.png" alt="06" caption="" border="true" %}
{% include figure.html file="/assets/20180517/07.png" alt="07" caption="" border="true" %}
<br>
원하는 이름을 지어줍니다. 저는 `machineLearningTest` 라고 지었어요. IAM role 선택하는 부분에서 None을 눌러 Default 값으로 sageMaker를 만듭니다.<br><br>

{% include figure.html file="/assets/20180517/08.png" alt="08" caption="인고의 Pending 시간
" border="true" %}<br><br><br>

## 3. Pending이 끝나고 “open” action을 선택하면 Jupyter가 열립니다.
{% include figure.html file="/assets/20180517/09.png" alt="09" caption="" border="true" %}<br>
...
{% include figure.html file="/assets/20180517/10.png" alt="10" caption="MNIST dataset" border="true" %} <br>
...
{% include figure.html file="/assets/20180517/11.png" alt="11" caption="" border="true" %}
<br><br><br>
...
{% include figure.html file="/assets/20180517/12.png" alt="12" caption="" border="true" %}<br>
...
{% include figure.html file="/assets/20180517/13.png" alt="13" caption="서른 번째 데이터는 누군가 3을 손글씨로 쓴 이미지입니다." border="true" %}<br><br><br>


## 6. 머신러닝 학습하기
이 세션에서는 기계학습 알고리즘 설정, 학습할 데이터 경로를 지정하겠습니다. 그 후 MNIST 학습 데이터를 S3 버킷에 옮겨 저장합니다.<br><br>

{% include figure.html file="/assets/20180517/14.png" alt="14" caption="" border="true" %}
<br>
`kmeans.fit()` 함수를 호출해 직접 학습을 시켜볼까요? 학습 과정은 상당히 오래 걸린다고 했는데 다행히 4분 만에 학습이 끝났습니다. <br><br>

{% include figure.html file="/assets/20180517/15.png" alt="15" caption="" border="true" %}
<br>
**여기서 잠깐!** <br>
...
{% include figure.html file="/assets/20180517/16.png" alt="16" caption="" border="true" %}
<br><br><br>

## 7. 학습된 모델을 배포하기
학습을 시키면 테스트를 하거나 사용할 수 있어야겠죠? 학습된 모델을 배포해 주세요.
<br><br>
{% include figure.html file="/assets/20180517/17.png" alt="17" caption="" border="true" %}
<br><br><br>

## 8. 배포된 모델 테스트 진행하기
배포된 모델에 valid_set 데이터로 검증 데이터를 진행합니다.<br><br>

{% include figure.html file="/assets/20180517/18.png" alt="18" caption="" border="true" %}
<br>
...
{% include figure.html file="/assets/20180517/19.png" alt="19" caption="" border="true" %}
{% include figure.html file="/assets/20180517/20.png" alt="20" caption="" border="true" %}
<br><br><br><br>
...
<br><br>
{% include figure.html file="/assets/20180517/21.jpg" alt="21" caption="" border="true" %}<br>
...
{% include figure.html file="/assets/20180517/22.png" alt="22" caption="fashion-mnist.pkl.gz가 업로드 되었습니다!" border="true" %}<br><br><br>


## 3. 머신러닝 학습하기
아까 사용했던 활용했던 숫자 MNIST 스크립트를 그대로 사용하겠습니다.  `show_digit()`을 이름만 바꾼 `show_fashion()`으로 데이터를 살펴보니 드레스가 보입니다.<br><br>

{% include figure.html file="/assets/20180517/23.png" alt="23" caption="" border="true" %}
<br>
...
{% include figure.html file="/assets/20180517/24.png" alt="24" caption="" border="true" %}
<br>
머신러닝이라고 겁내지 않아도 됩니다! 유저들에게 더 좋은 서비스 제공할 수 있으니까요. 지금까지 브랜디 개발2팀의 단아한 개발자 오연ㅈ…. <br><br>

{% include figure.html file="/assets/20180517/25.png" alt="25" caption="참사를 막아주세요." border="true" %}
<br>
