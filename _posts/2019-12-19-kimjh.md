...
{% include figure.html file="/assets/20191219_2/02.jpeg" alt="dark" caption="[그림2] WWDC19 다크모드 발표 영상 중 일부" width="fitcontent" %}
...
{% include figure.html file="/assets/20191219_2/03.png" alt="dark" caption="[그림3] 다크 모드에서 적용하고 싶은 이미지 추가 화면" width="fitcontent" %}
...
{% include figure.html file="/assets/20191219_2/05.png" alt="dark" caption="[그림5] 시뮬레이터 설정 화면" width="fitcontent" %}
...
{% include figure.html file="/assets/20191219_2/07.png" alt="dark" caption="[그림7] 스토리보드 하단 메뉴" width="fitcontent" %}
...
{% include figure.html file="/assets/20191219_2/08.gif" alt="dark" caption="[그림8] 제어 센터를 통한 다크 모드 전환" width="fitcontent" %}
...
{% include figure.html file="/assets/20191219_2/09.jpeg" alt="dark" caption="[그림9] 브랜디의 라이트 모드와 다크 모드(예정) 모습" width="fitcontent" %}<br />
