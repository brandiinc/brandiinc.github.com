...
{% include figure.html file="/assets/20180812/01.jpg" alt="01" caption="Apple Developer 웹사이트에서 수많은 기술 관련 영상을 볼 수 있다." border="true" %} <br>
...
{% include figure.html file="/assets/20180812/02.jpg" alt="02" caption="Development Videos - Apple Developer 첫 화면" border="true" %} <br>

{% include figure.html file="/assets/20180812/03.jpg" alt="03" caption="Topics 에서는 주제별 동영상들을 볼 수 있다." border="true" %} <br>

{% include figure.html file="/assets/20180812/04.jpg" alt="04" caption="Library 에서는 검색하는 키워드에 해당하는 동영상들을 볼 수 있다." border="true" %} <br>
...
{% include figure.html file="/assets/20180812/05.PNG" alt="05" caption="WWDC 앱에서 제공하는 행사장 지도" border="true" %} <br>

{% include figure.html file="/assets/20180812/06.jpg" alt="06" caption="세션이 진행되는 곳의 내부" border="true" %}<br>

{% include figure.html file="/assets/20180812/07.jpg" alt="07" caption="수많은 개발자의 똑똑한 머리와 지미집" border="true" %} <br>
...
{% include figure.html file="/assets/20180812/08.jpg" alt="08" caption="행사장에서 제공하는 아침 식사와 함께 맥북 프로에서 라이브로 세션 시청" border="true" %} <br><br><br>
...
{% include figure.html file="/assets/20180812/09.jpg" alt="09" caption="Keynote 발표 중 한 장면. 크레이그 페더리기가 AR 파트에서 Shared experiences에 대해 발표하고 있다." border="true" %} <br>
...
{% include figure.html file="/assets/20180812/10.jpg" alt="10" caption="SwiftShot AR게임을 즐기려고 기다리는 개발자들" border="true" %} <br>
...
{% include figure.html file="/assets/20180812/11.jpg" alt="11" caption="그리드 레이아웃, 또는 UICollectionViewFlowLayout으로 구현할 수 있는 레이아웃 " border="true" %} <br>
...
{% include figure.html file="/assets/20180812/12.jpg" alt="12" caption="브랜디 앱, 인스타그램 앱, 세션 예제 앱의 모자이크 레이아웃" border="true" %} <br>
...
{% include figure.html file="/assets/20180812/13.png" alt="13" caption="빌드 시간을 아름답게 줄일 수 있다." border="true" %} <br>

이것은 Xcode 10에서 Scheme Editor에서 설정할 수 있습니다. 프로젝트의 Target → Edit Scheme → Build → Build Options에서 Parallelize Build를 체크하면 됩니다. 

{% include figure.html file="/assets/20180812/14.png" alt="14" caption="Xcode 10의 Parallelize Build" border="true" %} <br>
...
{% include figure.html file="/assets/20180812/15.png" alt="15" caption="Build With Timing Summary를 선택하여 빌드하면" border="true" %} <br>

{% include figure.html file="/assets/20180812/16.png" alt="16" caption="위 스크린샷처럼 요약해서 보여준다." width="fitcontent" border="true" %} <br>
...
## Technology Labs
{% include figure.html file="/assets/20180812/17.jpg" alt="17" caption="technology Labs 간판" border="true" %} <br>

{% include figure.html file="/assets/20180812/24.jpg" alt="18" caption="Labs 입구에 있는 부스별 주제" border="true" %}  <br>

{% include figure.html file="/assets/20180812/19.jpg" alt="19" caption="짙은 남색 Engineer 티셔츠를 입은 애플 기술자들이 질문을 받고 있다." border="true" %}  <br> 
...
{% include figure.html file="/assets/20180812/20.jpg" alt="20" caption="무대와, 맥주와, bash 입장권" border="true" %}  <br>

{% include figure.html file="/assets/20180812/21.jpg" alt="21" caption="한국인 개발자들과 함께 즐긴 뒤풀이 파티" border="true" %}  <br>

{% include figure.html file="/assets/20180812/22.jpg" alt="22" caption="초청 가수를 소개하러 무대에 올라온 크레이그 페더러기" border="true" %}  <br>

{% include figure.html file="/assets/20180812/23.jpg" alt="23" caption="아름다운 노을!" border="true" %}  <br>
